...
class MigrationsTest {
    ...
    void migracoes_aplicam_e_semeiam_dados_deterministicos() throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            assertThat(count(statement, "select count(*) from vinculo_carteira where gerente_id = 'gerente.a'"))
                    .isEqualTo(7);
            assertThat(count(statement, "select count(*) from vinculo_carteira where gerente_id = 'gerente.b'"))
                    .isEqualTo(3);
            assertThat(count(statement, "select count(*) from vinculo_carteira where cliente_id = '999'"))
                    .isEqualTo(0);
        }
    }
